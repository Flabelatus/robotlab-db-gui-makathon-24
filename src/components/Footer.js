            ...
            <div className="row" style={{ backgroundColor: 'blue' }}>
                <footer className="text-center container-fluid py-2">
                    <div className="row">
                        ...
                        <div className="col mt-4">
                            <p style={{ fontWeight: 300, color: 'white', fontSize: 16 }}>Version March '24</p><Link to="https://github.com/Flabelatus/woodPlatformGo/tree/master" className="fa-brands fa-github" /> <br /><i className="fa-brands fa-youtube" />
                        </div>
                    </div>
                </footer>
            </div>
